  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="lg:hidden space-y-6">
        {/* Engine Statistics Cards - First on mobile */}
        ...
        {/* Real-time Anomaly Detection - Second on mobile */}
        <AnomalyDetection />

        {/* Failure Risk Timeline - Third on mobile */}
        <Card>
          <CardHeader>
      ...
      <div className="hidden lg:grid lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col h-auto lg:h-[600px] space-y-6 lg:space-y-0">
          {/* Top KPI Cards - 2x2 Grid - Takes up half height on desktop, full space on mobile */}
          <div className="grid grid-cols-2 gap-4 lg:flex-1 lg:mb-4">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-base font-medium">Total Engines</CardTitle>
                <Activity className="h-5 w-5 text-muted-foreground" />
          ...
          {/* Failure Risk Timeline - Takes up half height on desktop, full space on mobile */}
